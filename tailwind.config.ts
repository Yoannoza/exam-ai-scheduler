...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'subtle': '0 1px 2px rgba(0, 0, 0, 0.03), 0 1px 6px -1px rgba(0, 0, 0, 0.02), 0 2px 4px rgba(0, 0, 0, 0.02)',
				...
				'sidebar': '0 2px 10px -2px rgba(0, 0, 0, 0.05), 1px 0 5px -2px rgba(0, 0, 0, 0.02)'
			},
